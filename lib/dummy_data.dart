...
class UDummyData {
  ...
  static final List<BrandModel> brands = [
    BrandModel(
      id: '1',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683282/Brands%20Images/l5iepjakinialypihqjc.png',
      name: 'Nike',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '2',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683284/Brands%20Images/cwdniifsv5czqmskj6te.jpg',
      name: 'Adidas',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '3',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683285/Brands%20Images/gjlt05no0fafup0egeev.jpg',
      name: 'Apple',
      productsCount: 8,
      isFeatured: true,
    ),
    BrandModel(
      id: '4',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683287/Brands%20Images/ecrg4knfcdugzqdicda2.png',
      name: 'Bata',
      productsCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '5',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683288/Brands%20Images/nr6y7opqyshl3bnetuhk.png',
      name: 'Bloody',
      productsCount: 9,
      isFeatured: false,
    ),
    BrandModel(
      id: '6',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683290/Brands%20Images/ykkmjpgmvbl2tljchyoj.jpg',
      name: 'Breakout',
      productsCount: 7,
      isFeatured: true,
    ),
    BrandModel(
      id: '7',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683291/Brands%20Images/dorlj9n6kex7cpdqz9m2.png',
      name: 'Dari Mooch',
      productsCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '8',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683293/Brands%20Images/vhuwupc51rlio8qatwcq.jpg',
      name: 'Interwood',
      productsCount: 9,
      isFeatured: false,
    ),
    BrandModel(
      id: '9',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683294/Brands%20Images/r07i2xemcwjqkapxwvky.jpg',
      name: 'HP',
      productsCount: 4,
      isFeatured: false,
    ),
    BrandModel(
      id: '10',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683295/Brands%20Images/iw0gu0bfro2xhossw7st.png',
      name: 'J.',
      productsCount: 8,
      isFeatured: true,
    ),
    BrandModel(
      id: '11',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683296/Brands%20Images/mh2adzizpbomjofp5520.png',
      name: 'NDURE',
      productsCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '12',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683298/Brands%20Images/xjf2nx6gj5ve1ligvrb9.jpg',
      name: 'NorthStar',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '13',
      image:
          'https://res.cloudinary.com/dixbfe7cl/image/upload/v1771683300/Brands%20Images/jsmvlager64niyohaea2.png',
      name: 'Polo',
      productsCount: 2,
      isFeatured: true,
    ),
  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
      ...
      brand: brands[2],
      images: [
        UImages.productImage4b,
        UImages.productImage4c,
        UImages.productImage4d,
        UImages.productImage4e,
      ],
      sku: 'ABR4568',
      categoryId: '19',
      productAttributes: [
    ...
    ProductModel(
      ...
      images: [
        UImages.productImage33b,
        UImages.productImage33c,
        UImages.productImage33d,
      ],
      description:
  ...
  static final List<BrandCategoryModel> brandCategory = [
    ...
    // Clothes - Adidas
    BrandCategoryModel(categoryId: '1', brandId: '6'),
    // Clothes - Breakout
    BrandCategoryModel(categoryId: '1', brandId: '13'),

    // Clothes - Polo
    BrandCategoryModel(categoryId: '2', brandId: '1'),
    // Shoes - Nike
    BrandCategoryModel(categoryId: '2', brandId: '11'),
    // Shoes - NDURE
    BrandCategoryModel(categoryId: '2', brandId: '4'),
    // Shoes - Bata
    BrandCategoryModel(categoryId: '2', brandId: '2'),

    // Shoes - Adidas
    BrandCategoryModel(categoryId: '3', brandId: '7'),
    // Cosmetics - Dari mooch
    BrandCategoryModel(categoryId: '3', brandId: '10'),
    // Cosmetics - j.
    BrandCategoryModel(categoryId: '3', brandId: '12'),

    // Cosmetics - North Star
    BrandCategoryModel(categoryId: '4', brandId: '3'),
    // Electronics - Apple
    BrandCategoryModel(categoryId: '4', brandId: '5'),
    // Electronics - Bloody
    BrandCategoryModel(categoryId: '4', brandId: '9'),

    // Electronics - HP
    BrandCategoryModel(categoryId: '5', brandId: '8'),

    // Furniture - InterWood
    BrandCategoryModel(categoryId: '6', brandId: '1'),
    // Sports - Nike
  ];
  ...
  //       id: '2',
  //       code: 'FLAT50',
  //       name: 'Flat ${UText.currency}50 Off',
  //       discount: 50,
